            ...
            <div className="bg-white rounded-2xl shadow border border-slate-200 p-6 md:p-8 lg:p-10">
              ...
              {results.length > 0 ? (
                ...
                <div className="space-y-4">
                  ...
                  <button onClick={() => handleSearchWithUrl(lastSubmittedUrl)} disabled={loading} className="w-full flex items-center justify-center gap-2 bg-[#2b66e5] hover:bg-[#2456c7] disabled:bg-[#6b9aef] text-white font-medium py-3 px-6 rounded-full transition-colors">
                    <RefreshCw size={18} className={loading ? 'animate-spin' : ''} />
                    Try searching again
                  </button>
                </div>
