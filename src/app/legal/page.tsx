    ...
    <main className="min-h-screen bg-slate-50 py-16 px-4">
      <div className="mx-auto max-w-3xl rounded-xl bg-white p-8 shadow-sm border border-slate-200 space-y-8">
        ...
        <section className="space-y-3">
          ...
          <p className="text-slate-700">
            To report alleged infringement, submit a DMCA notice via the contact email listed at the bottom of this page. Include:
          </p>
          ...
          <p className="text-slate-700">
            If you believe material was removed by mistake, submit a counter notice via the contact email listed at the bottom of this page. Include your contact details, a statement under penalty of perjury that the removal was a mistake or misidentification, consent to court jurisdiction, and your signature.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-slate-700">
            Subject to law, you may request access, correction, deletion, restriction, or a portable copy of your data via the contact email listed at the bottom of this page.
          </p>
        ...
        {/* 11. Hosting Transparency */}
        <section className="space-y-3">
          <h2 className="text-2xl font-semibold text-slate-900">11. Hosting Transparency</h2>
          <p className="text-slate-700">
            MirrorSource is hosted on Vercel. Vercel may process technical data to operate and secure the platform. See Vercel policies for details.
          </p>
        </section>

        {/* 12. Legal Disclaimer */}
        <section className="space-y-3">
          <h2 className="text-2xl font-semibold text-slate-900">12. Legal Disclaimer</h2>
          <p className="text-slate-700">
            MirrorSource provides AI-generated summaries for information only. MirrorSource does not provide legal, financial, or professional advice. All trademarks and copyrights belong to their respective owners.
          </p>
        </section>
