      ...
      <div className="space-y-3">
        <div className="flex items-start gap-3">
          ...
          <p className="text-sm text-slate-600">
            <span className="font-medium text-slate-700">Public search only.</span> We search the open web for coverage of your story—no paywalls accessed.
          </p>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <p className="text-sm text-slate-600">
            <span className="font-medium text-slate-700">AI-generated summary.</span> Our summary is created from public sources, not copied from any article.
          </p>
        </div>
